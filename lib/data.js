...
export const I18N = {
  pt: { qg: 'QG DO GUERREIRO', forge: 'A FORJA', ops: 'PROJETOS & TAREFAS', journal: 'DIÁRIO DE BORDO', stats: 'RELATÓRIOS DE COMBATE', enemy: 'O INIMIGO REVELADO', settings: 'CONFIGURAÇÕES',
    nav_qg: 'QG', nav_forge: 'Forja', nav_ops: 'Missões', nav_journal: 'Diário', nav_stats: 'Dados', nav_enemy: 'Inimigo', nav_library: 'Biblioteca', nav_settings: 'Ajustes', library: 'BIBLIOTECA DO GUERREIRO',
    ...
    mood_Forte: 'Forte', mood_Estável: 'Estável', mood_Ansioso: 'Ansioso', mood_Vulnerável: 'Vulnerável',
  ...
  en: { qg: 'WARRIOR HQ', forge: 'THE FORGE', ops: 'PROJECTS & TASKS', journal: 'SHIP LOG', stats: 'COMBAT REPORTS', enemy: 'THE ENEMY REVEALED', settings: 'SETTINGS',
    nav_qg: 'HQ', nav_forge: 'Forge', nav_ops: 'Missions', nav_journal: 'Journal', nav_stats: 'Data', nav_enemy: 'Enemy', nav_library: 'Library', nav_settings: 'Setup', library: 'WARRIOR LIBRARY',
  ...
  es: { qg: 'QG DEL GUERRERO', forge: 'LA FORJA', ops: 'PROYECTOS & TAREAS', journal: 'DIARIO DE A BORDO', stats: 'INFORMES DE COMBATE', enemy: 'EL ENEMIGO REVELADO', settings: 'AJUSTES',
    nav_qg: 'QG', nav_forge: 'Forja', nav_ops: 'Misiones', nav_journal: 'Diario', nav_stats: 'Datos', nav_enemy: 'Enemigo', nav_library: 'Biblioteca', nav_settings: 'Ajustes', library: 'BIBLIOTECA DEL GUERRERO',
